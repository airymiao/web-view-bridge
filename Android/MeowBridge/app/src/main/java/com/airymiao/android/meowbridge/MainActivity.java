package com.airymiao.android.meowbridge;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String AppLogTag = "MeowBridge";


    WebView bridgeWebView;
    MeowBridgeWebViewClient bridgeWebViewClient;
    String urlString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.urlString = "http://192.168.11.71:8081/";
        this.renderWebView();
    }
    ...
    private void registerJavascriptBridge(WebView bridgeWebView) {
        bridgeWebViewClient = new MeowBridgeWebViewClient(bridgeWebView);
