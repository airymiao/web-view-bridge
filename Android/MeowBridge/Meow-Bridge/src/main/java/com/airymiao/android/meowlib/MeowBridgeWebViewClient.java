package com.airymiao.android.meowlib;
 ...
 */
public class MeowBridgeWebViewClient extends WebViewClient {
    ...
    public MeowBridgeWebViewClient(WebView webView) {
        this(webView, null);
    }

    public MeowBridgeWebViewClient(WebView webView, WVJBHandler messageHandler) {
    ...
    private void injectJavascriptFile() {
        executeJavascript(MeowBridgeWebViewJavascriptBridge.loadMeowBridgeJavascript());
